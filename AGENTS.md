...
**Second levier de renouvellement** : le **registre des risques et actions** du contribuable
(après le rapport de mission) — conception `docs/25-registre-risques-actions.md`. Sans suivi,
une revue ponctuelle se résilie ; avec suivi, résilier = perdre le registre d'engagements.
...
| **État réel du référentiel (chiffres scan)** | `revue-fiscale-v5/docs/14-etat-referentiel.md` |
| **Bloqueurs humains (CGI, visa, tarifs, Resend)** | `revue-fiscale-v5/docs/15-bloqueurs-humains.md` |
| **Audit profondeur SaaS (doctrine / portail)** | `revue-fiscale-v5/docs/24-audit-profondeur-saas.md` |
| **Engagement cabinet (périmètre, tâches)** | `revue-fiscale-v5/docs/23-engagement-cabinet.md` |
| **Registre risques & actions (post-mission)** | `revue-fiscale-v5/docs/25-registre-risques-actions.md` |
| **Lot fiscaliste 8 pistes Annexe** | `revue-fiscale-v5/docs/18-lot-fiscaliste-annexe-8.md` |
| **Ingestion CGI cgici / re-run** | `revue-fiscale-v5/docs/17-ingestion-cgici.md` |
