"""Seed propositions Annexe 2026 (8 pistes) — file éditoriale, pas visa."""
...
from backend.editorial.pistes_annexe import deposer_propositions_pistes  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Dépose les ~8 propositions Annexe 2026 (a_valider_humain). "
